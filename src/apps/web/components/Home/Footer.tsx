            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="hover:text-white transition">OLX Blog</a></li>
                    ...
                    {/* Column 3 - OLX */}
                    <div>
                        <h3 className="text-white font-bold text-lg mb-4">OLX</h3>
                        <ul className="space-y-2">
                            <li><a href="#" className="hover:text-white transition">Terms & Conditions</a></li>
                            <li><a href="#" className="hover:text-white transition">Privacy Policy</a></li>
                            <li><a href="#" className="hover:text-white transition">OLX People</a></li>
                            <li><a href="#" className="hover:text-white transition">Promote Your Ad</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mb-4">
                            ...
                            <div className="flex flex-col gap-2">
                                <a href="#" className="bg-black rounded-lg px-4 py-2 flex items-center gap-2 hover:bg-gray-800 transition">
                ...
                <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <a href="#" className="text-sm hover:text-white transition">Terms of Use</a>
